...
<br/>
<FlexRow center>
  <img src="/public/img/example_editors.png" alt="A grid of node editor screenshots including, Blender, Unreal Engine, Substance Designer, and GoDot" style={{maxWidth: 800, width: '100%'}} />
</FlexRow>

## Logic Extraction

As a side benefit, putting complex business logic into the hands of users, frees developers from the complexity of maintaining complex logic in code. This reduces the surface area for bugs and makes defining business logic accessible for non-programmers in your organization.

Additionally, because business logic can be stored in JSON structures in your database, business logic can be swapped out in your application remotely without requiring a new build of your application's code.
