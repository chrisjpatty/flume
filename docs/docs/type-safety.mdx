...
> As a note, while familiarity with the concept of type safety may be helpful for developing with Flume, using Typescript itself is *not* required to use Flume (although it is supported).
