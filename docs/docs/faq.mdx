...
If you answered yes to any of these questions, Flume could be a great choice to aleviate some of the above problems. Checkout the [getting started guide](/docs/quick-start) to learn more.
...
No! The engine for resolving logic can be used in any Javascript environment. In fact, part of the power of Flume is the ability to easily share your business logic between your frontend and backend. That being said, the node editor itself does requires a browser-like environment in order to run.
