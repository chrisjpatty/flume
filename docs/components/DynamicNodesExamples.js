...
//       const dynamicInputs = [...new Set(ids).values()]
//         .map(id => ports.string({ name: id, label: id }));
//       return [
...
// uncomment all of this once we've updated flume in this docs/ project

export const ComposeExample = () => <div />;
export const RequiredExample = () => <div />;
export const WarningExample = () => <div />;
